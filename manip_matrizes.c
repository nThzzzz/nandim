...
Fracao **criarMatriz(int *linhas, int *colunas) {//Função de criar matrizes
  ...
  scanf("%d", colunas);
  //Pego as linhas e as colunas por endereço e salvo nas variáveis, assim podemos usar elas em outras funções,como se fosse uma variável global, mas não sendo porque usamos ponteiros, slk a cabeça do pae abriu nessa ta
